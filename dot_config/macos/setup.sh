...
ln -s $(pwd)/folders.zh_CN.strings ~/Codes.localized/.localized/zh_CN.strings
ln -s $(pwd)/folders.zh_CN.strings ~/Knowledge.localized/.localized/zh_CN.strings
ln -s $(pwd)/folders.zh_CN.strings ~/Works.localized/.localized/zh_CN.strings
